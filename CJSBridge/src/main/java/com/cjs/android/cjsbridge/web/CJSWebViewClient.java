...
import com.cjs.android.cjsbridge.common.scheme.CJSchemeParser;
...
public class CJSWebViewClient extends WebViewClient {
    ...
    public void onPageFinished(final WebView view, final String url) {
        ...
        try {
            ...
            executeJavascript(view, js, new CJSBridge.CallH5CallBack() {
                @Override
    ...
    private void executeJavascript(WebView webView, String js, CJSBridge.CallH5CallBack callBack) throws CJSBException {
        CJSBridge.callH5(webView, js, callBack);
    }
}
